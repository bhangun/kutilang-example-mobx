...
mixin _$UserStore on _UserStore, Store {
  ...
  User get userProfile =>
      (_$userProfileComputed ??= Computed<User>(() => super.userProfile,
              name: '_UserStore.userProfile'))
          .value;
  Computed<User> _$userDetailComputed;

  @override
  User get userDetail => (_$userDetailComputed ??=
          Computed<User>(() => super.userDetail, name: '_UserStore.userDetail'))
      .value;
  ...
  @override
  User get profile2 {
    _$profile2Atom.reportRead();
    return super.profile2;
  }

  @override
  set profile2(User value) {
    _$profile2Atom.reportWrite(value, super.profile2, () {
  ...
  final _$getUserListAsyncAction = AsyncAction('_UserStore.getUserList');
  ...
  dynamic add() {
    final _$actionInfo =
        _$_UserStoreActionController.startAction(name: '_UserStore.add');
    try {
      return super.add();
    } finally {
      _$_UserStoreActionController.endAction(_$actionInfo);
